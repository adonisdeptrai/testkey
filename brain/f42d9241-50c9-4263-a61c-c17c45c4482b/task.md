...
- [x] Backend Implementation
    - [x] Update `binancePay.js` utils (Add Webhook Verification, Query Order)
...
- [x] Frontend Implementation
    - [x] Update `Checkout.tsx` to add "Binance Pay" method
...
- [x] Check TPBank API
    - [x] Review Backend Utility (`tpbank.js`)
    - [x] Review Frontend Monitor (`TPBankMonitor.tsx`)
...
- [x] Deployment Preparation
    ...
    - [x] Create `deploy.sh` helper script
- [x] Documentation
    - [x] Create Beginner Guide (`docs/GUIDE-aapanel-deploy.md`)
